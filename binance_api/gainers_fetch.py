...
def fetch_top_gainers_from_database(table_name, limit=10):
    try:
        ...
        query = f"SELECT coin_symbol, percentage_change_24h, current_price FROM {table_name}  WHERE coin_symbol LIKE '%usdt%' ORDER BY percentage_change_24h DESC LIMIT {limit}"
